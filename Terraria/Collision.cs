...
namespace Terraria
{
	public class Collision
	{
		...
		public static Vector4 SlopeCollision_Yor(Vector2 Position, Vector2 Velocity, int Width, int Height, float gravity = 0f, bool fall = false)
		{
			...
			{
				for (int num12 = num10; num12 != num8; num12 += num6)
				{
					if (Main.tile[num11, num12] != null && Main.tile[num11, num12].active() && !Main.tile[num11, num12].inActive() && (Main.tileSolid[(int)Main.tile[num11, num12].type] || (Main.tileSolidTop[(int)Main.tile[num11, num12].type] && Main.tile[num11, num12].frameY == 0)))
					{
						Vector2 vector4;
						vector4.X = (float)(num11 * 16);
						vector4.Y = (float)(num12 * 16);
						int num13 = 16;
						...
						if (Position.X + (float)Width > vector4.X && Position.X < vector4.X + 16f && Position.Y + (float)Height > vector4.Y && Position.Y < vector4.Y + (float)num13)
						{
							bool flag = true;
							if (Main.tile[num11, num12].slope() > 0)
							{
								if (Main.tile[num11, num12].slope() > 2)
								{
									if (Main.tile[num11, num12].slope() == 3 && vector.Y + Math.Abs(Velocity.X) + 1f >= vector4.Y && vector.X >= vector4.X)
									{
										flag = true;
									}
									if (Main.tile[num11, num12].slope() == 4 && vector.Y + Math.Abs(Velocity.X) + 1f >= vector4.Y && vector.X + (float)Width <= vector4.X + 16f)
									{
										flag = true;
									}
								}
								...
								{
									if (Main.tile[num11, num12].slope() == 1 && vector.Y + (float)Height - Math.Abs(Velocity.X) - 1f <= vector4.Y + (float)num13 && vector.X >= vector4.X)
									{
										flag = true;
									}
									if (Main.tile[num11, num12].slope() == 2 && vector.Y + (float)Height - Math.Abs(Velocity.X) - 1f <= vector4.Y + (float)num13 && vector.X + (float)Width <= vector4.X + 16f)
									{
										flag = true;
									}
								}
							...
							if (Main.tile[num11, num12].type == 19)
							{
								...
								if (Position.Y + (float)Height < (float)(num12 * 16) || Position.Y + (float)Height - (1f + Math.Abs(Velocity.X)) > (float)(num12 * 16 + 16))
								{
									flag = false;
								}
							}
							if (flag)
							{
								...
								int num14 = (int)Main.tile[num11, num12].slope();
								vector4.X = (float)(num11 * 16);
								vector4.Y = (float)(num12 * 16);
								if (Position.X + (float)Width > vector4.X && Position.X < vector4.X + 16f && Position.Y + (float)Height > vector4.Y && Position.Y < vector4.Y + 16f)
								{
									...
									if (num14 == 3 || num14 == 4)
									{
										if (num14 == 3)
										{
											num15 = Position.X - vector4.X;
										}
										if (num14 == 4)
										{
											num15 = vector4.X + 16f - (Position.X + (float)Width);
										}
										if (num15 >= 0f)
										{
											if (Position.Y <= vector4.Y + 16f - num15)
											{
												float num16 = vector4.Y + 16f - vector.Y - num15;
												if (Position.Y + num16 > y2)
												{
													vector2.Y += num16;
													y2 = vector2.Y;
									...
									if (num14 == 1 || num14 == 2)
									{
										...
										if (num15 >= 0f)
										{
											if (Position.Y + (float)Height >= vector4.Y + num15)
											{
												float num18 = vector4.Y - (vector.Y + (float)Height) + num15;
												if (Position.Y + num18 < y)
												{
													if (flag2)
													{
										...
										{
											float num19 = vector4.Y - (float)Height;
											if (vector2.Y > num19)
											{
												if (flag2)
												{
			...
			{
				float num20 = velocity.Y - vector5.Y;
			...
			{
				float num21 = vector5.Y - velocity.Y;
				vector2.Y = Position.Y + vector5.Y;
				if (array[3])
				{
					vector2.X = Position.X - num21;
				}
				if (array[4])
				{
					vector2.X = Position.X + num21;
