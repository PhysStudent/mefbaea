	...
	public static class IngameOptions
	{
		...
		public static void Draw(Main mainInstance, SpriteBatch sb)
		{
			...
			if (IngameOptions.category == 0)
			{
				...
				num9++;
				anchor2.X += 70f;
				if (IngameOptions.DrawRightSide(sb, Main.autoSave ? Lang.menu[67] : Lang.menu[68], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, Main.autoPause ? Lang.menu[69] : Lang.menu[70], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, Main.showItemText ? Lang.menu[71] : Lang.menu[72], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, Main.cSmartToggle ? Lang.menu[121] : Lang.menu[122], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[123] + " " + Lang.menu[124 + Main.invasionProgressMode], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, Main.placementPreview ? Lang.menu[128] : Lang.menu[129], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, ChildSafety.Disabled ? Lang.menu[132] : Lang.menu[133], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
				...
				num9++;
				if (IngameOptions.DrawRightSide(sb, ItemSlot.Options.HighlightNewItems ? Lang.inter[117] : Lang.inter[116], num9, anchor2, offset2, IngameOptions.rightScale[num9], (IngameOptions.rightScale[num9] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num9;
					if (flag)
					{
			...
			{
				int num10 = 0;
				if (IngameOptions.DrawRightSide(sb, Main.graphics.IsFullScreen ? Lang.menu[49] : Lang.menu[50], num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
				...
				}), num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num10;
					if (flag)
					{
				...
				IngameOptions.valuePosition.X = value3.X + value2.X - (float)(num / 2) - 20f;
				IngameOptions.valuePosition.Y = IngameOptions.valuePosition.Y - 3f;
				float num12 = IngameOptions.DrawValueBar(sb, 0.75f, (float)Main.bgScroll / 100f);
				...
				num10++;
				anchor2.X += 70f;
				if (IngameOptions.DrawRightSide(sb, Main.terrariasFixedTiming ? Lang.menu[53] : Lang.menu[54], num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num10;
					if (flag)
					{
				...
				num10++;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[55 + Lighting.lightMode], num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num10;
					if (flag)
					{
				...
				num10++;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[116] + " " + ((Lighting.LightingThreads > 0) ? string.Concat(Lighting.LightingThreads + 1) : Lang.menu[117]), num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num10;
					if (flag)
					{
				...
				num10++;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[59 + Main.qaStyle], num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num10;
					if (flag)
					{
				...
				num10++;
				if (IngameOptions.DrawRightSide(sb, Main.owBack ? Lang.menu[100] : Lang.menu[101], num10, anchor2, offset2, IngameOptions.rightScale[num10], (IngameOptions.rightScale[num10] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num10;
					if (flag)
					{
			...
			if (IngameOptions.category == 2)
			{
				...
				anchor2.X -= 30f;
				int num14 = 0;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[74 + num14], num13, anchor2, offset2, IngameOptions.rightScale[num13], (IngameOptions.rightScale[num13] - num2) / (num3 - num2), (Main.setKey == num14) ? Color.Gold : default(Color)))
				{
				...
				num13++;
				num14 = 12;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[120], num13, anchor2, offset2, IngameOptions.rightScale[num13], (IngameOptions.rightScale[num13] - num2) / (num3 - num2), (Main.setKey == num14) ? Color.Gold : default(Color)))
				{
					IngameOptions.rightHover = num13;
					if (flag)
					{
				...
				num13++;
				num14 = 13;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[130], num13, anchor2, offset2, IngameOptions.rightScale[num13], (IngameOptions.rightScale[num13] - num2) / (num3 - num2), (Main.setKey == num14) ? Color.Gold : default(Color)))
				{
					IngameOptions.rightHover = num13;
					if (flag)
					{
			...
			if (IngameOptions.category == 3)
			{
				...
				anchor2.X -= 30f;
				int num16 = 0;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[106 + num16], num15, anchor2, offset2, IngameOptions.rightScale[num15], (IngameOptions.rightScale[num15] - num2) / (num3 - num2), (Main.setKey == num16) ? Color.Gold : default(Color)))
				{
				...
				num15++;
				anchor2.X += 30f;
				if (IngameOptions.DrawRightSide(sb, Lang.menu[86], num15, anchor2, offset2, IngameOptions.rightScale[num15], (IngameOptions.rightScale[num15] - num2) / (num3 - num2), default(Color)))
				{
					IngameOptions.rightHover = num15;
					if (flag)
					{
