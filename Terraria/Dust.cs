...
namespace Terraria
{
	public class Dust
	{
			...
			while (i < 6000)
			{
				...
				if (!dust.active)
				{
					...
					if (dust.type == 228 || dust.type == 135 || dust.type == 6 || dust.type == 242 || dust.type == 75 || dust.type == 169 || dust.type == 29 || (dust.type >= 59 && dust.type <= 65) || dust.type == 158)
					{
						...
						Dust expr_431_cp_0 = dust;
						expr_431_cp_0.velocity.X = expr_431_cp_0.velocity.X * 0.3f;
						dust.scale *= 0.7f;
					}
					...
					if (dust.type == 33 || dust.type == 52 || dust.type == 266 || dust.type == 98 || dust.type == 99 || dust.type == 100 || dust.type == 101 || dust.type == 102 || dust.type == 103 || dust.type == 104 || dust.type == 105)
					{
						dust.alpha = 170;
						dust.velocity *= 0.5f;
						Dust expr_53E_cp_0 = dust;
						expr_53E_cp_0.velocity.Y = expr_53E_cp_0.velocity.Y + 1f;
					}
					if (dust.type == 41)
					{
						dust.velocity *= 0f;
		...
		public static void UpdateDust()
		{
					...
					if (dust.active)
					{
						...
						if (dust.firstFrame && !ChildSafety.Disabled && ChildSafety.DangerousDust(dust.type))
						{
							if (Main.rand.Next(2) == 0)
							{
								...
								Dust expr_10D_cp_0 = dust;
								expr_10D_cp_0.frame.X = expr_10D_cp_0.frame.X - 1000 * num2;
								Dust expr_126_cp_0 = dust;
								expr_126_cp_0.frame.Y = expr_126_cp_0.frame.Y + 30 * num2;
								dust.noGravity = true;
							}
							else
							{
						...
						else if (dust.type == 228 || dust.type == 229 || dust.type == 6 || dust.type == 242 || dust.type == 135 || dust.type == 127 || dust.type == 187 || dust.type == 75 || dust.type == 169 || dust.type == 29 || (dust.type >= 59 && dust.type <= 65) || dust.type == 158)
						{
							if (!dust.noGravity)
							{
								Dust expr_10CD_cp_0 = dust;
								expr_10CD_cp_0.velocity.Y = expr_10CD_cp_0.velocity.Y + 0.05f;
							}
						...
						else if (dust.type == 159)
						{
							...
							else
							{
								dust.scale += 0.005f;
								dust.velocity *= 0.9f;
								Dust expr_18C9_cp_0 = dust;
								expr_18C9_cp_0.velocity.X = expr_18C9_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
								Dust expr_18F0_cp_0 = dust;
								expr_18F0_cp_0.velocity.Y = expr_18F0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
								if (Main.rand.Next(5) == 0)
								{
						...
						else if (dust.type == 164)
						{
							...
							else
							{
								dust.scale -= 0.005f;
								dust.velocity *= 0.9f;
								Dust expr_1A8C_cp_0 = dust;
								expr_1A8C_cp_0.velocity.X = expr_1A8C_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
								Dust expr_1AB3_cp_0 = dust;
								expr_1AB3_cp_0.velocity.Y = expr_1AB3_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
								if (Main.rand.Next(5) == 0)
								{
						...
						else if (dust.type == 173)
						{
							...
							{
								dust.velocity *= 0.8f;
								Dust expr_1BC6_cp_0 = dust;
								expr_1BC6_cp_0.velocity.X = expr_1BC6_cp_0.velocity.X + (float)Main.rand.Next(-20, 21) * 0.01f;
								Dust expr_1BED_cp_0 = dust;
								expr_1BED_cp_0.velocity.Y = expr_1BED_cp_0.velocity.Y + (float)Main.rand.Next(-20, 21) * 0.01f;
								dust.scale -= 0.01f;
							}
							else
							{
								dust.scale -= 0.015f;
								dust.velocity *= 0.8f;
								Dust expr_1C53_cp_0 = dust;
								expr_1C53_cp_0.velocity.X = expr_1C53_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.005f;
								Dust expr_1C7A_cp_0 = dust;
								expr_1C7A_cp_0.velocity.Y = expr_1C7A_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.005f;
						...
						else if (dust.type == 160 || dust.type == 162)
						{
							...
							{
								dust.velocity *= 0.8f;
								Dust expr_1E26_cp_0 = dust;
								expr_1E26_cp_0.velocity.X = expr_1E26_cp_0.velocity.X + (float)Main.rand.Next(-20, 21) * 0.04f;
								Dust expr_1E4D_cp_0 = dust;
								expr_1E4D_cp_0.velocity.Y = expr_1E4D_cp_0.velocity.Y + (float)Main.rand.Next(-20, 21) * 0.04f;
								dust.scale -= 0.1f;
							}
							else
							{
								dust.scale -= 0.1f;
								Dust expr_1E9D_cp_0 = dust;
								expr_1E9D_cp_0.velocity.X = expr_1E9D_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
								Dust expr_1EC4_cp_0 = dust;
								expr_1EC4_cp_0.velocity.Y = expr_1EC4_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
						...
						else if (dust.type == 168)
						{
							...
							dust.scale += 0.03f;
							Dust expr_200A_cp_0 = dust;
							expr_200A_cp_0.velocity.X = expr_200A_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
							Dust expr_2031_cp_0 = dust;
							expr_2031_cp_0.velocity.Y = expr_2031_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
							dust.velocity *= 0.99f;
						}
						else if (dust.type >= 139 && dust.type < 143)
						{
							Dust expr_2093_cp_0 = dust;
							expr_2093_cp_0.velocity.X = expr_2093_cp_0.velocity.X * 0.98f;
							Dust expr_20AA_cp_0 = dust;
							expr_20AA_cp_0.velocity.Y = expr_20AA_cp_0.velocity.Y * 0.98f;
							if (dust.velocity.Y < 1f)
							{
								Dust expr_20D3_cp_0 = dust;
								expr_20D3_cp_0.velocity.Y = expr_20D3_cp_0.velocity.Y + 0.05f;
							}
							dust.scale += 0.009f;
						...
						{
							Dust expr_21A9_cp_0 = dust;
							expr_21A9_cp_0.velocity.Y = expr_21A9_cp_0.velocity.Y * 0.98f;
							Dust expr_21C0_cp_0 = dust;
							expr_21C0_cp_0.velocity.X = expr_21C0_cp_0.velocity.X * 0.98f;
						...
						{
							dust.scale -= 0.01f;
							Dust expr_226C_cp_0 = dust;
							expr_226C_cp_0.velocity.X = expr_226C_cp_0.velocity.X * 0.96f;
							if (!dust.noGravity)
							{
								Dust expr_228E_cp_0 = dust;
								expr_228E_cp_0.velocity.Y = expr_228E_cp_0.velocity.Y + 0.1f;
							}
						}
						else if (dust.type >= 244 && dust.type <= 247)
						{
							...
							float num75 = ((float)b / 270f + 1f) / 2f;
						...
						else if (dust.type == 43)
						{
							...
							float num79 = (float)color2.R / 270f;
							float num80 = (float)color2.G / 270f;
							float num81 = (float)color2.B / 270f;
							float num82 = (float)(dust.color.R / 255);
							float num83 = (float)(dust.color.G / 255);
							float num84 = (float)(dust.color.B / 255);
						...
						{
							Dust expr_275F_cp_0 = dust;
							expr_275F_cp_0.velocity.Y = expr_275F_cp_0.velocity.Y * 0.98f;
							Dust expr_2776_cp_0 = dust;
							expr_2776_cp_0.velocity.X = expr_2776_cp_0.velocity.X * 0.98f;
						...
						else if (dust.type == 66)
						{
							...
							Dust expr_2B7D_cp_0 = dust;
							expr_2B7D_cp_0.velocity.Y = expr_2B7D_cp_0.velocity.Y * 0.98f;
							Dust expr_2B94_cp_0 = dust;
							expr_2B94_cp_0.velocity.X = expr_2B94_cp_0.velocity.X * 0.98f;
							dust.scale += 0.02f;
						...
						else if (dust.type == 267)
						{
							...
							Dust expr_2CA2_cp_0 = dust;
							expr_2CA2_cp_0.velocity.Y = expr_2CA2_cp_0.velocity.Y * 0.98f;
							Dust expr_2CB9_cp_0 = dust;
							expr_2CB9_cp_0.velocity.X = expr_2CB9_cp_0.velocity.X * 0.98f;
							dust.scale += 0.02f;
						...
						{
							dust.scale += 0.005f;
							Dust expr_2DC0_cp_0 = dust;
							expr_2DC0_cp_0.velocity.Y = expr_2DC0_cp_0.velocity.Y * 0.94f;
							Dust expr_2DD7_cp_0 = dust;
							expr_2DD7_cp_0.velocity.X = expr_2DD7_cp_0.velocity.X * 0.94f;
						...
						{
							int arg_3326_0 = (int)dust.position.X / 16;
							int arg_3336_0 = (int)dust.position.Y / 16;
							Main.snowDust++;
							dust.scale += 0.009f;
							if (!dust.noLight)
							{
						...
						else if (!dust.noGravity && dust.type != 41 && dust.type != 44)
						{
							...
							{
								Dust expr_33D1_cp_0 = dust;
								expr_33D1_cp_0.velocity.Y = expr_33D1_cp_0.velocity.Y + 0.1f;
							}
						}
						...
						if (dust.type == 33 || dust.type == 52 || dust.type == 266 || dust.type == 98 || dust.type == 99 || dust.type == 100 || dust.type == 101 || dust.type == 102 || dust.type == 103 || dust.type == 104 || dust.type == 105 || dust.type == 123)
						{
							...
							if (dust.noGravity)
							{
								...
								dust.scale += 0.03f;
								Dust expr_35CE_cp_0 = dust;
								expr_35CE_cp_0.velocity.X = expr_35CE_cp_0.velocity.X * 1.05f;
								Dust expr_35E5_cp_0 = dust;
								expr_35E5_cp_0.velocity.Y = expr_35E5_cp_0.velocity.Y + 0.15f;
							}
						}
						if (dust.type == 35 && dust.noGravity)
						{
							...
							if (dust.scale < 1f)
							{
								Dust expr_3633_cp_0 = dust;
								expr_3633_cp_0.velocity.Y = expr_3633_cp_0.velocity.Y + 0.075f;
							}
							Dust expr_364A_cp_0 = dust;
							expr_364A_cp_0.velocity.X = expr_364A_cp_0.velocity.X * 1.08f;
							if (dust.velocity.X > 0f)
							{
								dust.rotation += 0.01f;
							}
						...
						else if (dust.type == 152 && dust.noGravity)
						{
							...
							if (dust.scale < 1f)
							{
								Dust expr_3737_cp_0 = dust;
								expr_3737_cp_0.velocity.Y = expr_3737_cp_0.velocity.Y + 0.075f;
							}
							Dust expr_374E_cp_0 = dust;
							expr_374E_cp_0.velocity.X = expr_374E_cp_0.velocity.X * 1.08f;
							if (dust.velocity.X > 0f)
							{
								dust.rotation += 0.01f;
							}
						...
						else if (dust.type == 34 || dust.type == 35 || dust.type == 152)
						{
							...
							else
							{
								...
								Dust expr_39EF_cp_0 = dust;
								expr_39EF_cp_0.velocity.X = expr_39EF_cp_0.velocity.X + (float)Main.rand.Next(-10, 10) * 0.002f;
						...
						if (dust.type == 41)
						{
							Dust expr_3B9D_cp_0 = dust;
							expr_3B9D_cp_0.velocity.X = expr_3B9D_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.01f;
							Dust expr_3BC4_cp_0 = dust;
							expr_3BC4_cp_0.velocity.Y = expr_3BC4_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.01f;
						...
						{
							Dust expr_3D04_cp_0 = dust;
							expr_3D04_cp_0.velocity.X = expr_3D04_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.003f;
							Dust expr_3D2B_cp_0 = dust;
							expr_3D2B_cp_0.velocity.Y = expr_3D2B_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.003f;
						...
						{
							Dust expr_3E5B_cp_0 = dust;
							expr_3E5B_cp_0.velocity.X = expr_3E5B_cp_0.velocity.X * 0.99f;
						}
						if (dust.type != 79)
						{
						...
						if (dust.fadeIn > 0f && dust.fadeIn < 100f)
						{
							if (dust.type == 235)
							{
								...
								{
									Vector2 vector3 = dust.position - Main.player[num106].Center;
									float num107 = vector3.Length();
									num107 = 100f - num107;
									if (num107 > 0f)
									{
									...
									vector3 *= -num108;
									dust.velocity = (dust.velocity * 4f + vector3) / 5f;
								}
							}
						...
						if (dust.type >= 130 && dust.type <= 134)
						{
							...
							{
								dust.velocity *= 0.98f;
								Dust expr_4227_cp_0 = dust;
								expr_4227_cp_0.velocity.Y = expr_4227_cp_0.velocity.Y - 0.1f;
								dust.scale += 0.0025f;
							}
							else
							{
			...
			int num113 = num;
			if ((double)num113 > (double)Main.numDust * 0.9)
			{
				Dust.dCount = 0.9f;
				return;
			}
			if ((double)num113 > (double)Main.numDust * 0.8)
			{
				Dust.dCount = 0.8f;
				return;
			}
			if ((double)num113 > (double)Main.numDust * 0.7)
			{
				Dust.dCount = 0.7f;
				return;
			}
			if ((double)num113 > (double)Main.numDust * 0.6)
			{
				Dust.dCount = 0.6f;
				return;
			}
			if ((double)num113 > (double)Main.numDust * 0.5)
			{
				Dust.dCount = 0.5f;
				return;
			}
