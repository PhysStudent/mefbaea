	...
	internal static class MapHelper
	{
		...
		public static void LoadMapVersion2(BinaryReader fileIO, int release)
		{
			...
			for (int i = 0; i < 419; i++)
			{
				...
				{
					num13 = (ushort)(num13 + (ushort)MapHelper.tileOptionCounts[i]);
				}
			}
			ushort num18 = num14;
			for (int i = 0; i < 225; i++)
			{
				...
				{
					num13 = (ushort)(num13 + (ushort)MapHelper.wallOptionCounts[i]);
				}
			}
			ushort num21 = num14;
			for (int i = 0; i < 3; i++)
